        ...
        HStack(spacing: 12) {
            ...
            HStack(spacing: 8) {
                Button {
                    ...
                    Image(
                        systemName: filer.isAutomountEnabled
                            ? "bolt.fill" : "bolt"
                    )
                    .font(.system(size: 14))
                    .foregroundColor(
                        filer.isAutomountEnabled
